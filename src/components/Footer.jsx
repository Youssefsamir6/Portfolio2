    ...
    <footer className="border-t border-white/5 py-8">
      <div className="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        <p className="text-white/30 text-sm">
          Designed & built by Youssef Samir Refky &copy; {new Date().getFullYear()}
        </p>
        <div className="flex items-center gap-4">
          <a href={personalInfo.github} target="_blank" rel="noopener" className="text-white/30 hover:text-white transition-colors">
            <GitHubIcon />
          </a>
          <a href={personalInfo.linkedin} target="_blank" rel="noopener" className="text-white/30 hover:text-white transition-colors">
            <LinkedInIcon />
          </a>
          <a href={`mailto:${personalInfo.email}`} className="text-white/30 hover:text-white transition-colors">
            <EmailIcon />
          </a>
        </div>
      </div>
